...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2017 at 02:52 PM
...
CREATE TABLE IF NOT EXISTS `tbl_program_course` (
  ...
  `program_course_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:Active & 2:Inactive',
...
INSERT INTO `tbl_program_course` (`program_course_id`, `program_course_name`, `program_course_logo`, `program_course_status`, `delete_flag`) VALUES
(1, 'Classic', '1511957926.jpg', 1, 0),
(2, 'Classic Accademy', '1511958374.jpg', 1, 0),
(3, 'test', '1511922232.jpg', 1, 0);
