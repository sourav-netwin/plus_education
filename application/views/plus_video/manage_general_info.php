...
<script src="<?php echo base_url(); ?>js/admin/manage_general_info.js?v=0.1"></script>

<div class="right_col" role="main">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 15px;">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<a class="btn btn-primary" href="<?php echo base_url(); ?>manage_general_info/add_edit"><i class="fa fa-plus" aria-hidden="true"></i> Add general info</a>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
