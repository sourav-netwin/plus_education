...
?>
						<input type="hidden" name="centre_latitude" id="centre_latitude" value="<?php echo $post['centre_latitude'] ?>" />
						<input type="hidden" name="centre_longitude" id="centre_longitude" value="<?php echo $post['centre_longitude'] ?>" />
